        ...
        <div className="bg-[#1e19197c]">
          <div className="md:w-[60%] mx-auto text-center p-5">
            ...
            <p className="text-lg font-light text-white py-2">
              ...
              or simply want to connect with our team, we are here to assist
              you. Please feel free to reach out using the provided contact
              form, email address, or phone number. We strive to respond
              promptly to all your messages and ensure that your concerns are
              addressed effectively. Your input is invaluable in helping us
              improve our services and meet your needs. We look forward to
              hearing from you and providing the assistance you require.
            </p>
          </div>
          <div className="w-[90%] mx-auto pb-5">
            <div className="border-2 border-[#1e19197c] rounded-xl shadow-xl p-5 w-full flex justify-between items-center">
              ...
              <div className="md:w-[50%]">
                <form >
                    <h1 className="text-5xl font-medium text-white text-center">Your Information</h1>
                    <input className="w-full text-2xl p-3 bg-transparent border-b-2 border-black text-white outline-none focus:outline-none" type="text" name="name" placeholder="Name" />
                    <input className="w-full text-2xl p-3 bg-transparent border-b-2 border-black text-white outline-none focus:outline-none" type="Email" name="email" placeholder="Email" />
                    <textarea
                      name="message"
                      id=""
                      cols="10"
                    ...
                    ></textarea>
                    <button className="w-full py-3 bg-orange-400 hover:bg-orange-600 text-white text-2xl rounded-3xl mt-3">Submit Contact</button>
                </form>
              </div>
            </div>
          </div>
